 ...
 *  Copyright (C) 1998, 1999, 2000, 2001, 2002  Damon Chaplin
 *                2003  Damon Chaplin, Joaquin Cuenca Abela
 *
...
#define GLADE_ICON_KEY			"GladeIconKey"
#define GLADE_MENU_ITEM_STOCK_ID_KEY	"GladeMenuItemStockIDKey"
