...
G_DEFINE_TYPE (GladeRecentChooserWidgetEditor, glade_recent_chooser_widget_editor, GLADE_TYPE_EDITOR_SKELETON)
...
glade_recent_chooser_widget_editor_class_init (GladeRecentChooserWidgetEditorClass * klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/gladegtk/glade-recent-chooser-widget-editor.ui");
}
